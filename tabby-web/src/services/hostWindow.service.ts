    ...
    constructor (
        ...
        const unloadHandler = (event) => {
            if (config.store.web.preventAccidentalTabClosure) {
                ...
                event.returnValue = translate.instant('Are you sure you want to close TabShell? You can disable this prompt in Settings -> Window.')
            } else {
