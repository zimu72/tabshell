...
> 👋 Managing remote environments? Check out [Warpgate, my smart SSH/HTTP/MySQL bastion server](https://github.com/warp-tech/warpgate), it works great with TabShell, you'll love it.

----

### Downloads:

* [Latest release](https://github.com/zimu72/tabshell/releases/latest)
* [Repositories](https://packagecloud.io/zimu72/tabshell): [Debian/Ubuntu-based](https://packagecloud.io/zimu72/tabshell/install#bash-deb), [RPM-based](https://packagecloud.io/zimu72/tabshell/install#bash-rpm)
* [Latest nightly build](https://nightly.link/zimu72/tabshell/workflows/build/master)
...
[**TabShell**](https://github.com/zimu72/tabshell) (formerly **Tabby**) is a highly configurable terminal emulator, SSH and serial client for Windows 10, macOS and Linux
...
* SSH, SFTP and Telnet client available as a [web app](https://tabby.sh/app) (also [self-hosted](https://github.com/zimu72/tabshell-web)).

# Contents <!-- omit in toc -->

- [What TabShell is and isn't](#what-tabshell-is-and-isnt)
...
# What TabShell is and isn't

* **TabShell is** an alternative to Windows' standard terminal (conhost), PowerShell ISE, PuTTY, macOS Terminal.app and iTerm

* **TabShell is not** a new shell or a MinGW or Cygwin replacement. Neither is it lightweight - if RAM usage is of importance, consider [Conemu](https://conemu.github.io) or [Alacritty](https://github.com/jwilm/alacritty)
...
* [docker](https://github.com/zimu72/tabshell-docker) - connect to Docker containers
* [title-control](https://github.com/zimu72/terminus-title-control) - allows modifying the title of the terminal tabs by providing a prefix, suffix, and/or strings to be removed
* [quick-cmds](https://github.com/zimu72/terminus-quick-cmds) - quickly send commands to one or all terminal tabs
* [save-output](https://github.com/zimu72/tabshell-save-output) - record terminal output into a file
* [sync-config](https://github.com/zimu72/terminus-sync-config) - sync the config to Gist or Gitee
* [clippy](https://github.com/zimu72/tabshell-clippy) - an example plugin which annoys you all the time
* [workspace-manager](https://github.com/zimu72/tabshell-workspace-manager) - allows creating custom workspace profiles based on the given config
* [search-in-browser](https://github.com/zimu72/tabshell-search-in-browser) - opens default system browser with a text selected from the Tabby's tab
* [sftp-tab](https://github.com/zimu72/tabshell-sftp-tab) - open sftp tab for ssh connection like SecureCRT
* [background](https://github.com/zimu72/tabshell-background) - change Tabby background image and more...
* [highlight](https://github.com/zimu72/tabshell-highlight) - Tabby terminal keyword highlight plugin
* [web-auth-handler](https://github.com/zimu72/tabshell-web-auth-handler) - In-app web authentication popups (Built primarily for warpgate in-browser auth)
...
* [hype](https://github.com/zimu72/tabshell-theme-hype) - a Hyper inspired theme
...
See [HACKING.md](https://github.com/zimu72/tabshell/blob/master/HACKING.md) and [API docs](https://docs.tabby.sh/) for information of how the project is laid out, and a very brief plugin development tutorial.
