...
export class ThemesService {
    ...
    private applyThemeVariables () {
        ...
        let themeBg = theme.background
        let themeFg = theme.foreground
        const isDark = Color(themeBg).luminosity() < Color(themeFg).luminosity()
        ...
        if (this.findCurrentTheme().followsColorScheme) {
            vars['--bs-body-bg'] = themeBg
            vars['--bs-body-color'] = themeFg
            ...
            vars['--theme-fg-more-2'] = more(themeFg, 0.5).string()
            vars['--theme-fg-more'] = more(themeFg, 0.25).string()
            vars['--theme-fg'] = themeFg
            vars['--theme-fg-less'] = less(themeFg, 0.25).string()
            vars['--theme-fg-less-2'] = less(themeFg, 0.5).string()

            vars['--theme-bg-less-2'] = less(themeBg, 0.5).string()
            vars['--theme-bg-less'] = less(themeBg, 0.25).string()
            vars['--theme-bg'] = themeBg
            vars['--theme-bg-more'] = backgroundMore
            vars['--theme-bg-more-2'] = more(backgroundMore, 0.25).string()

            vars['--theme-ui-bg'] = isDark ? backgroundMore : background.string()
            ...
            const themeColors = {
                ...
                secondary: isDark
                    ? less(themeBg, 0.5).string()
                    : less(themeBg, 0.125).string(),
                tertiary: more(themeBg, 0.75).string(),
                warning: theme.colors[3],
                danger: theme.colors[1],
                success: theme.colors[2],
                info: theme.colors[4],
                dark: more(themeBg, 0.75).string(),
                light: more(themeFg, 0.5).string(),
