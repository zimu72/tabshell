...
export class HomeBaseService {
    ...
    openGitHub (): void {
        this.platform.openExternal('https://github.com/zimu72/tabshell')
    }
    ...
    reportBug (): void {
        ...
        this.platform.openExternal(`https://github.com/zimu72/tabshell/issues/new?body=${encodeURIComponent(body)}`)
    }
