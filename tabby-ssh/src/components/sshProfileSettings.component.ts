...
export class SSHProfileSettingsComponent {
    ...
    async ngOnInit () {
        ...
        if (this.profile.options.user) {
            try {
                ...
                this.hasSavedPassword = !!password || !!this.profile.options.password
            } catch (e) {
                console.error('Could not check for saved password', e)
                this.hasSavedPassword = !!this.profile.options.password
            }
        }
    }
    ...
    clearSavedPassword () {
        ...
        this.profile.options.password = undefined
