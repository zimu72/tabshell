...
export const configPath = path.join(process.env.TABSHELL_CONFIG_DIRECTORY!, 'config.yaml')
const legacyConfigPath = path.join(process.env.TABSHELL_CONFIG_DIRECTORY!, '../terminus', 'config.yaml')
