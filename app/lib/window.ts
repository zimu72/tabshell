...
type MaybeGlasstronWindow = BrowserWindow & {
    blurType?: string
...
export class Window {
    ...
    private window?: MaybeGlasstronWindow
    ...
    constructor (private application: Application, private configStore: any, options?: WindowOptions) {
        ...
        if (process.platform === 'darwin') {
            ...
            try {
                ...
                console.error('Failed to create glasstron window', e)
                this.window = new BrowserWindow(bwOptions)
            }
        }
        ...
        this.ready = new Promise(resolve => {
            ...
            let listener: (event: any) => void = () => null
            const cleanup = (): void => {
                if (timeout) {
