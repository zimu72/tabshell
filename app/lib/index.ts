// Disable sandbox via environment variable (needed for AppImage)
// This must be set before importing Electron
...
process.env.TABSHELL_PLUGINS ??= ''
process.env.TABSHELL_CONFIG_DIRECTORY ??= app.getPath('userData')
